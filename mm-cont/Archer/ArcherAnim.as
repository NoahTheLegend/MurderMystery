...
void onTick(CSprite@ this)
{
	...
	if ((firing || legolas) && hasArrows(blob))
	{
		f32 armangle = -angle;
	...
	else if (blob.isKeyPressed(key_action1) && hasArrows(blob))
	{
...
void DrawBowEffects(CSprite@ this, CBlob@ blob, ArcherInfo@ archer, const u8 arrowType)
{
	...
	doQuiverUpdate(this, blob.get_u8("role") == 1, true);
}

bool IsFiring(CBlob@ blob)
{
	return blob.isKeyPressed(key_action1) && hasArrows(blob);
}
