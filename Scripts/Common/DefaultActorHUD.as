...
void renderHPBar(CBlob@ blob, Vec2f origin)
{
	...
	for (f32 step = 0.0f; step < blob.getHealth(); step += 0.5f)
	{
...
void onRender(CSprite@ this)
{
	...
	if (getGameTime() < intro_time + 30) return;
